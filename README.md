...
### To add a phone to the list of supported devices:

- Log into developer.apple.com
- Choose Account
- Find the Devices area and add the device
  - NOTE: The UDID is just the Serial Number with a hyphen after the 8th character
- Launch XCode and open the project
- Open Runner and navigate to the Signing & Capabilities tab
- Make sure there are no issues downloading the lates profile



### To deploy the release version
